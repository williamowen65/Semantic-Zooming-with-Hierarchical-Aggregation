...
(() => {
  ...
  // The same relationship can play a different response role depending on which
  // post is the current parent. From the surplus-food solution it is a positive
  // consequence (yay); from homelessness it is a proposed solution.
