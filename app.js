...
// Load the richer synthetic public-participation dataset after the rest of the
// page has installed its semantic styling and interaction wrappers. The data
// module re-renders when ready.
window.addEventListener("DOMContentLoaded",()=>{
  const script=document.createElement("script");
  script.src=`public-data.js?v=${Date.now()}`;
