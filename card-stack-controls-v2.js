...
(() => {
  ...
  function rootCard(y){
    ...
    const html=`<div xmlns="http://www.w3.org/1999/xhtml" class="layer-context-card is-issue ${rootOpen?'children-visible':''}" role="button" tabindex="0" aria-pressed="${rootOpen}"><div class="layer-context-copy"><div class="layer-context-primary"><span class="layer-context-kind">Issue collection</span><span class="layer-context-name">Root challenges</span></div><div class="layer-context-description">Top-level issues across the full Atlas hierarchy.</div></div><div class="layer-context-stats"><span class="layer-context-stat"><strong>${voteText}</strong> votes</span><span class="layer-context-stat"><strong>${(forestData||[]).length}</strong> roots</span></div></div>`;
